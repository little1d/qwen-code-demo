...
def perform_kaplan_meier_analysis(discontinuation_df):
    ...
    for treatment in treatment_groups:
        ...
        print(f"  180天生存概率: {kmf.survival_function_at_times(180) if 180 in kmf.survival_function_.index else 'N/A'}")
...
if __name__ == "__main__":
    ...
    # 执行Kaplan-Meier分析
    kmf = perform_kaplan_meier_analysis(discontinuation_df)
    
    # 执行Log-rank检验
    logrank_results = perform_logrank_test(discontinuation_df)
    ...
    print("生存分析结果已保存至 task4/tables/ 和 task4/figures/ 目录")