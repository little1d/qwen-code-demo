...
if __name__ == "__main__":
    ...
    # 保存医疗资源利用比较结果
    resource_comparison.to_csv('task4/tables/resource_utilization_comparison.csv', index=False)
    
    # 保存成本比较结果
    cost_comparison.to_csv('task4/tables/cost_comparison.csv', index=False)
    print("成本比较结果已保存至 task4/tables/cost_comparison.csv")